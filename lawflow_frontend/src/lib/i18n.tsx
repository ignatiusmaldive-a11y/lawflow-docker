...
const EN: Dict = {
  ...
  dropboxFolderTitle: "Dropbox",
  dropboxFolderHint: "Assign or create a Dropbox folder for this matter.",
  dropboxFolderPlaceholder: "e.g. Dropbox/LawFlow/0123-matter-name",
  dropboxAssigned: "Assigned",
  dropboxNotAssigned: "No folder assigned yet.",
  dropboxAssign: "Assign",
  dropboxCreate: "Create",
  saving: "Saving…",
  dropboxSaveFailed: "Could not save Dropbox folder. Try again.",
  dropboxCreateFailed: "Could not create Dropbox folder. Try again.",
  chooseFile: "Choose file",
  uploading: "Uploading…",
  uploadFailed: "Upload failed. Try again.",
  dragDrop: "Drag & drop files here to upload",
  preview: "Preview",
  previewPending: "Preview is pending (coming soon).",
...
const ES: Dict = {
  ...
  dropboxFolderTitle: "Dropbox",
  dropboxFolderHint: "Asigna o crea una carpeta de Dropbox para este asunto.",
  dropboxFolderPlaceholder: "Ej. Dropbox/LawFlow/0123-nombre-del-asunto",
  dropboxAssigned: "Asignado",
  dropboxNotAssigned: "Aún no hay carpeta asignada.",
  dropboxAssign: "Asignar",
  dropboxCreate: "Crear",
  saving: "Guardando…",
  dropboxSaveFailed: "No se pudo guardar la carpeta de Dropbox. Inténtalo de nuevo.",
  dropboxCreateFailed: "No se pudo crear la carpeta de Dropbox. Inténtalo de nuevo.",
  chooseFile: "Elegir archivo",
  uploading: "Subiendo…",
  uploadFailed: "No se pudo subir. Inténtalo de nuevo.",
  dragDrop: "Arrastra y suelta archivos aquí para subirlos",
  preview: "Vista previa",
  previewPending: "Vista previa pendiente (próximamente).",
